class PersonalsController < ApplicationController
  ...
  private
    ...
    def personal_params
      params.require(:personal).permit(:player_name, :age, :team, :college, :average_points, :average_assists, :average_rebounds, :average_steals, :average_blocks, :average_turnover, :average_personal_foul)
    end
end
